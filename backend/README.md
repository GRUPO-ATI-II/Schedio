...
Agenda escolar: Aplicación de gestión de calificaciones y asignaturas que ofrece un cálculo automático de promedio.
Google Calendar: Calendario con eventos, recordatorios e integración con otros productos de Google como Google Meet y Gmail. Ofrece además calendarios de grupos.
